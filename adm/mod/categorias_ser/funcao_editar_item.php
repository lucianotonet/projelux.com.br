<?php
    ...
    if($nome==''){
        ...
        echo "<script type=text/javascript>window.location.href = '../../menu.php?sub=categorias_ser&acao=editar_item&id=".$id."';</script>";
    }
    else{
    	// Insere os dados no banco
        $sqltxt = "UPDATE categorias_ser SET cat_nome='".$nome."' WHERE cat_id=".$id." ";
