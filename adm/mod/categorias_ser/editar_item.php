<?php
    ...
    $sql="SELECT * FROM categorias_ser WHERE cat_id=".$id." ";
    $result=mysqli_query($mysqli, $sql);
    $row=mysqli_fetch_array($result, MYSQLI_ASSOC);
?>

<h5>Serviços &raquo; Categorias &raquo; <a href="#" class="active">Editar Cadastro</a></h5>
<fieldset>
    <form action="mod/categorias_ser/funcao_editar_item.php" method="post" enctype="multipart/form-data">
