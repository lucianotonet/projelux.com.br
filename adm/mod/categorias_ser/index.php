<script type="text/javascript">
  function excluir(id){
      if(window.confirm('Excluir este Cadastro?')){
          window.location.href='menu.php?sub=categorias_ser&acao=deletar_item&id='+id;
      }
  }
</script>
<?php
...
<?php
    ...
    $sql="SELECT * FROM categorias_ser ORDER BY cat_nome LIMIT ".$primeiro_registro.", ".$num_pag." ";
    ...
    $pg_atual = "menu.php?sub=categorias_ser&pagina=";
        ...
        <?php
            echo "<tr>";
                ...
                echo "<td class='action' style='width:5%'>";
                    echo "<a href='menu.php?sub=categorias_ser&acao=editar_item&id=".$row['cat_id']."' class='edit'><i class='fa fa-pencil fa-fw'></i></a>";
                echo "</td>";
                echo "<td class='action' style='width:5%'>";
