<script type="text/javascript">
  function excluir(id){
      if(window.confirm('Excluir esta dica?')){
          window.location.href='menu.php?sub=dicas&acao=deleta_item&id='+id;
      }
  }
</script>
<?php
...
<h5>Dicas &raquo; <a href="#" class="active" >Lista de Dicas</a></h5>

<?php
    $sql_total="SELECT * FROM dicas";
    $sql="SELECT * FROM dicas ORDER BY dic_nome LIMIT ".$primeiro_registro.", ".$num_pag." ";
    ...
    $pg_atual = "menu.php?sub=dicas&pagina=";
        ...
        <?php
            echo "<tr>";
                ...
                echo "<td class='action' style='width:5%'>";
                    echo "<a href='menu.php?sub=dicas&acao=edita_item&id=".$row['dic_id']."' class='edit'><i class='fa fa-pencil fa-fw'></i></a>";
                echo "</td>";
                echo "<td class='action' style='width:5%'>";
                    echo "<a onclick='excluir(".$row['dic_id'].")' href='#' class='delete'><i class='fa fa-remove fa-fw'></i></a>";
                echo "</td>";
            echo "</tr>";
        ?>
    </table>
