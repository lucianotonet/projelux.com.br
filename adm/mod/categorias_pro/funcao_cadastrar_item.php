<?php
    ...
    if($nome==''){
        ...
        echo "<script type=text/javascript>window.location.href = '../../menu.php?sub=categorias_pro&acao=cadastrar_item';</script>";
    }else{
        $sql_consulta="SELECT cat_nome FROM categorias_pro WHERE cat_nome='".$nome."' ";
        ...
        if($count_consulta!=false){
            ...
            $sqltxt = "INSERT INTO categorias_pro VALUES(NULL,'".$nome."')";
