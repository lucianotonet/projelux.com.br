...
<h5>Configurador &raquo; <a href="#" class="active" >Altera Configuração</a></h5>

<?php
	include_once 'inc/connect_db.php';

    $sql_total="SELECT * FROM setup";
    $sql="SELECT * FROM setup ORDER BY set_id LIMIT ".$primeiro_registro.", ".$num_pag." ";
    ...
    $pg_atual = "menu.php?sub=opcoes&acao=index_setup&pagina=";
        ...
        <?php
            echo "<tr>";
                ...
                echo "<td class='action' style='width:5%'>";
                    echo "<a href='menu.php?sub=opcoes&acao=editar_setup&id=".$row['set_id']."' class='edit'><i class='fa fa-pencil fa-fw'></i></a>";
                echo "</td>";
            echo "</tr>";
        ?>
    </table>
