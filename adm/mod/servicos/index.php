<script type="text/javascript">
  function excluir(id){
      if(window.confirm('Excluir este Cadastro?')){
          window.location.href='menu.php?sub=servicos&acao=deletar_item&id='+id;
      }
  }
</script>
<?php
...
<h5>Plotagens &raquo; <a href="#" class="active" >Lista de Serviços</a></h5>

<?php
    $sql_total="SELECT * FROM servicos";
    $sql="SELECT * FROM servicos ORDER BY ser_id DESC LIMIT ".$primeiro_registro.", ".$num_pag." ";
    ...
    $pg_atual = "menu.php?sub=servicos&pagina=";
        ...
        <?php
            echo "<tr>";
                ...
                echo "<td class='action' style='width:5%'>";
                    echo "<a href='menu.php?sub=servicos&acao=cadastrar_imagens&id=".$row['ser_id']."' class='edit'><i class='fa fa-image fa-fw'></i></a>";
                echo "</td>";
                echo "<td class='action' style='width:5%'>";
                    echo "<a href='menu.php?sub=servicos&acao=editar_item&id=".$row['ser_id']."' class='edit'><i class='fa fa-pencil fa-fw'></i></a>";
                echo "</td>";
                echo "<td class='action' style='width:5%'>";
                    echo "<a onclick='excluir(".$row['ser_id'].")' href='#' class='delete'><i class='fa fa-remove fa-fw'></i></a>";
                echo "</td>";
            echo "</tr>";
        ?>
    </table>
