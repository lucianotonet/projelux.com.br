<script type="text/javascript">
  function excluir(id){
      if(window.confirm('Excluir esta imagem ?')){
          window.location.href='menu.php?sub=servicos&acao=deletar_imagem&id='+id;
      }
  }
  $(document).ready(function(){
	...
	function muda_destaque(id,contador){
	    ...
	    window.location.href="menu.php?sub=servicos&acao=funcao_destaque&id="+id+"&destaque="+destaque;
	}
</script>
<?php
	...
	$sql1="SELECT * FROM servicos WHERE ser_id=".$id_item;
...
<h5><?=$row_res1['ser_nome']?> &raquo; <a href="#" class="active" >Lista de Imagens</a></h5>

<fieldset>
	<form enctype="multipart/form-data" action="mod/servicos/upload_imagens.php" method="post">
...
<?php
    $sql_total="SELECT * FROM fotos_servicos WHERE ftp_ser_id=".$id_item;
    $sql="SELECT * FROM fotos_servicos WHERE ftp_ser_id=".$id_item." ORDER BY ftp_id DESC LIMIT ".$primeiro_registro.", ".$num_pag." ";
    ...
    $pg_atual = "menu.php?sub=servicos&acao=cadastrar_imagens&id=".$id_item."&pagina=";
        ...
        <?php
            echo "<tr>";
                echo "<td style='width:75%'>";
                    echo "<img style='width: 150px;height: 113px;' src='../img/servicos/".$row["ftp_imagem"]."' />";
                echo "</td>";
