<script type="text/javascript">
  function excluir(id){
      if(window.confirm('Excluir este Cadastro?')){
          window.location.href='menu.php?sub=projetos&acao=deletar_item&id='+id;
      }
  }
</script>
<?php
...
<h5>Projetos &raquo; <a href="#" class="active" >Lista de Projetos</a></h5>

<?php
    $sql_total="SELECT * FROM projetos";
    $sql="SELECT * FROM projetos ORDER BY pro_id DESC LIMIT ".$primeiro_registro.", ".$num_pag." ";
    ...
    $pg_atual = "menu.php?sub=projetos&pagina=";
        ...
        <?php
            echo "<tr>";
                ...
                echo "<td class='action' style='width:5%'>";
                    echo "<a href='menu.php?sub=projetos&acao=cadastrar_imagens&id=".$row['pro_id']."' class='edit'><i class='fa fa-image fa-fw'></i></a>";
                echo "</td>";
                echo "<td class='action' style='width:5%'>";
                    echo "<a href='menu.php?sub=projetos&acao=editar_item&id=".$row['pro_id']."' class='edit'><i class='fa fa-pencil fa-fw'></i></a>";
                echo "</td>";
                echo "<td class='action' style='width:5%'>";
                    echo "<a onclick='excluir(".$row['pro_id'].")' href='#' class='delete'><i class='fa fa-remove fa-fw'></i></a>";
                echo "</td>";
            echo "</tr>";
        ?>
    </table>
