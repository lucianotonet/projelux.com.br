<script type="text/javascript">
  function excluir(id){
      if(window.confirm('Excluir esta imagem ?')){
          window.location.href='menu.php?sub=projetos&acao=deletar_imagem&id='+id;
      }
  }
  $(document).ready(function(){
	...
	function muda_destaque(id,contador){
	    ...
	    window.location.href="menu.php?sub=projetos&acao=funcao_destaque&id="+id+"&destaque="+destaque;
	}
</script>
<?php
	...
	$sql1="SELECT * FROM projetos WHERE pro_id=".$id_item;
...
<h5><?=$row_res1['pro_nome']?> &raquo; <a href="#" class="active" >Lista de Imagens</a></h5>

<fieldset>
	<form enctype="multipart/form-data" action="mod/projetos/upload_imagens.php" method="post">
    	<div class="bs-component">
	        <p><label><b>Observação:</b></label>
	            <i>As imagens deverão ter 1024px de largura e 768px de altura para ficar adequada ao layout.</i>
	        </p>
...
<?php
    $sql_total="SELECT * FROM fotos_projetos WHERE ftp_pro_id=".$id_item;
    $sql="SELECT * FROM fotos_projetos WHERE ftp_pro_id=".$id_item." ORDER BY ftp_id DESC LIMIT ".$primeiro_registro.", ".$num_pag." ";
    ...
    $pg_atual = "menu.php?sub=projetos&acao=cadastrar_imagens&id=".$id_item."&pagina=";
        ...
        <?php
            echo "<tr>";
                echo "<td style='width:75%'>";
                    echo "<img style='width: 150px;height: 113px;' src='../img/projetos/".$row["ftp_imagem"]."' />";
                echo "</td>";
