...
{	
	...
	// if(!is_numeric($subject)) //check entered data is numbers
	// {
	// 	$output = json_encode(array('type'=>'error', 'text' => 'O Assunto precisa ser somente números.'));
	// 	die($output);
	// }
	...
	if($file_attached) //continue if we have the file
	{
		...
		$headers .= "Content-type: text/html; charset=utf-8\r\n\r\n";
			...
			$body .= "<p><strong>Assunto: </strong><br />".$subject."</p>\r\n";
